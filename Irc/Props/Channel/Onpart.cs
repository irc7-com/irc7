...
internal class Onpart : PropRule
{
    ...
    public Onpart() : base(Resources.ChannelPropOnPart, EnumChannelAccessLevel.ChatHost,
        EnumChannelAccessLevel.ChatHost, Resources.ChannelPropOnpartRegex, string.Empty)
    {
    }
}